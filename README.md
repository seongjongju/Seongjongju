<div align= "center">
    <img src="https://capsule-render.vercel.app/api?type=waving&color=000000&height=180&text=Seong%20Jong%20Ju%20GitHub&animation=twinkling&fontColor=ffffff&fontSize=50" />
    </div>
    <div style="text-align: left;"> 
    <h2 style="border-bottom: 1px solid #d8dee4; color: #282d33;"> 만들고, 고민하고, 개선하는 프론트엔드 개발자입니다. </h2>  
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #282d33;"> 웹 퍼블리셔 경험을 바탕으로 React와 Next.js를 활용해 웹 서비스를 개발하고 있습니다.<br /></li></li>기능 구현에 그치지 않고 코드의 구조와 유지보수성, 사용자 경험을 함께 고민하며 개발합니다.<br /></li></li>실제 프로젝트를 통해 API 연동, 상태 관리, 인증, 결제 등 다양한 기능을 구현하고 </li>문제를 직면하며,<br /> 더 나은 방법을 찾아가는 과정을 중요하게 생각합니다. </div> 
    </div>
    <div style="text-align: left;">
